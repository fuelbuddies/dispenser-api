...
private:
  ...
  uint8_t tokhim_read_sale[5]               = {0x01, 0x41, 0x52, 0x7F, 0x6D};
  uint8_t tokhim_status[5]                  = {0x01, 0x41, 0x53, 0x7F, 0x6C};
  uint8_t tokhim_authorize_on[5]            = {0x01, 0x41, 0x41, 0x7F, 0x7E};
  uint8_t tokhim_authorize_off[5]           = {0x01, 0x41, 0x47, 0x7F, 0x78};
  uint8_t tokhim_show_preset[5]             = {0x01, 0x41, 0x43, 0x7F, 0x7C};
};
