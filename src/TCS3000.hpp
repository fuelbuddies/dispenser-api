...
private:
  const uint8_t totalizer[9] =     {0x7E, 0x01, 0x00, 0x40, 0x10, 0x02, 0x03, 0xF7, 0x0D};
  const uint8_t read_auth[7] =     {0x7E, 0x01, 0x00, 0x40, 0x1F, 0x00, 0x83};  //Duplicate
  ...
  const uint8_t read_status[7] =    {0x7E, 0x01, 0x00, 0x40, 0x2B, 0x00, 0x95};
  ...
  const uint8_t suspend_sale[7] =   {0x7E, 0x01, 0x00, 0x40, 0x39, 0x00, 0xE8};
  const uint8_t resume_sale[7] =    {0x7E, 0x01, 0x00, 0x40, 0x3A, 0x00, 0xBD};
